...
<form action="/placeorder" method="POST" class="needs-validation" novalidate>
    ...
    <div class="row g-3">
        <div class="col-sm-6">
            ...
            <input type="text" class="form-control" name="fullName" id="fullName" value="<%=name%>" required>
            <div class="invalid-feedback">Please enter reciever's name</div>
        </div>
        <div class="col-sm-6">
            <label for="mobile" class="form-label">Contact no.</label>
            <input type="number" class="form-control" id="mobile" value="<%=mobile%>" min="6000000000" max="9999999999" required>
    ...
    <div class="form-check">
        <input type="checkbox" class="form-check-input bg-dark border-dark" id="same-address" required>
    ...
    <h4 class="mb-3">Payment</h4>
        <div class="my-3">
            <div class="form-check">
                <input id="credit" name="paymentMethod" type="radio" class="form-check-input bg-dark" checked required>
                <label class="form-check-label" for="credit">Credit card</label>
            </div>
            <div class="form-check">
                <input id="debit" name="paymentMethod" type="radio" class="form-check-input bg-dark" required>
        ...
        <hr class="my-4">
        <button class="w-100 btn btn-dark btn-lg" type="submit">Place your order</button>
</form>
